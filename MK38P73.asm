...
init:       li bdrate      ; baud rate value for 9600bps - see App Note: "Using the MK3873 Serial Port" p. VI-2
...
monitor3:   ins cnport     ; wait here until READY bit goes high to indicate a character is available at the serial port
            bp monitor3
            pi getchar0    ; get the command character waiting at the serial port
...
dnload1:    ins cnport     ; wait here until READY bit goes high to indicate a character is available at the serial port
            bp dnload1
            pi getchar0    ; get the character waiting at the serial port
            lr A,rxdata    ; retrieve the character from the rx buffer
...
dnload7:    ins cnport     ; wait here until READY bit goes high to indicate a character is available at the serial port
            bp dnload7
            pi getchar0    ; get the last carriage return
            li '.'
            lr txdata,A
...
;-----------------------------------------------------------------------------------
getchar:    ins cnport     ; wait here until READY bit goes high to indicate a character is available at the serial port
            bp getchar
getchar0:   di             ; third level subroutine - can't be interrupted
