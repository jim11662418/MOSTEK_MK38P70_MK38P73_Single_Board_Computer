...
; after assembling, load the hex object code into executable
; RAM using the monitor's download function. the demo should
; start executing automatically after loading. reset the SBC to
...
delay1:     in 0FFH              ;     4 cycles
            ...
            end start            ; jump to 'start' after object code is downloaded
