...
;=========================================================================
; Monitor firmware for the Mostek MK38P70 Single Board Computer.
;
; this version for the MK38P70 uses software serial functions.
; port5.0 (pin 33) is used to transmit, port5.7 (pin 26) is used to receive.
;
...
monitor3:   ins serialport ; wait for the start bit
            bp monitor3
            pi getchar0    ; start bit detected, get the command character coming into the serial port
...
;------------------------------------------------------------------------
getbyte:    lr K,P         ; first level subroutine which calls second level subroutine 'get1hex'
            lr A,KU
            lr QU,A
            lr A,KL
            lr QL,A
...
;------------------------------------------------------------------------
get4hex:    lr K,P         ; first level subroutine which calls second level subroutines 'get1hex' and 'print1hex'
            lr A,KU
            lr QU,A
            lr A,KL
            lr QL,A
...
; F<ENTER> returns 0F
;------------------------------------------------------------------------
get2hex:    lr K,P         ; first level subroutine which calls second level subroutines 'get1hex' and 'print1hex'
            lr A,KU
            lr QU,A
            lr A,KL
            lr QL,A
...
;------------------------------------------------------------------------
print2hex:  lr K,P         ; first level subroutine which calls second level subroutine 'print1hex'
            lr A,KU
            lr QU,A
            lr A,KL
            lr QL,A
...
; returns with carry set if ESCAPE or ENTER key, else returns
; with carry clear and the 4 bit binary number in 'rxdata'.
;------------------------------------------------------------------------
get1hex:    lr K,P         ; second level subroutine which calls third level subroutine 'getchar'
get1hex1:   ins serialport ; wait here for the start bit
            bp get1hex1
            pi getchar0    ; start bit detected, get the character coming into the serial port
            lr A,rxdata    ; retrieve the character from the rx buffer
...
; valid hex digit was received. convert from ASCII character to binary number and save in 'rxdata'
get1hex5:   ci 'A'-1
...
;------------------------------------------------------------------------
print1hex:  lr K,P         ; second level subroutine which calls third level subroutine 'putchar'
...
;------------------------------------------------------------------------
printdecZ:  lr K,P         ; second level subroutine which calls third level subroutine 'putchar'
            li 0FFH
            lr zeroflag,A  ; set 'zeroflag'. all zeros will be printed
            br printdec1
...
printdec2:  lr A,digit
            ...
            bc printdec2   ; if there's no underflow, go back and subtract 100 from the number again
...
;-----------------------------------------------------------------------------------
putstr:     lr K,P         ; second level subroutine which calls third level subroutine 'putchar'
...
;-----------------------------------------------------------------------------------
newline:    lr K,P         ; second level subroutine which calls third level subroutine 'putchar'
...
;-----------------------------------------------------------------------------------
space:      lr K,P         ; second level subroutine which calls third level subroutine 'putchar'
            li ' '         ; space character
            lr txdata,A    ; put it into the tx buffer
            pi putchar     ; print the carriage return
            pk             ; return from second level subroutine
...
titletxt    db "\r\r"
            db "MK38P70 Serial Mini-Monitor\r"
